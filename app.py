...
def load_temp_data_2000_2013():
    ...
    return pd.read_csv("static/data/2000-2013_AverageTemp_WanakaAero.csv")

def load_temp_data_2022():
    """Loads temperature data for 2022."""
    return pd.read_csv("static/data/MonthlyTemp_WanakaAero_2022.csv")
...
def create_app():
    ...
    fig = create_rainfall_temp_chart(months, rain_2000_2013, rain_2022, temp_2000_2013, temp_2022)

    app.layout = html.Div(children=[
        html.Div([
            dcc.Graph(id='rainfall-temp-chart', figure=fig)
        ])
    ])

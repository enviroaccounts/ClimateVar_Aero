...
def load_rainfall_data_2000_2013():
    ...
    return pd.read_csv("static/data/2000-2013_AverageRainfall_WanakaAero.csv")

def load_rainfall_data_2022():
    """Loads rainfall data for 2022."""
    return pd.read_csv("static/data/MonthlyRainfall_WanakaAero_2022.csv")
...
def create_rainfall_bar_chart(months, values_2000_2013, values_2022):
...
def create_app():
    ...
    # Load data
    data_df_2000_2013 = load_rainfall_data_2000_2013()
    data_df_2022 = load_rainfall_data_2022()

    # Prepare data
    months, data_df_2000_2013, values_2022 = prepare_rainfall_chart_data(data_df_2000_2013, data_df_2022)

    # Create bar chart
    fig_bar_chart = create_rainfall_bar_chart(months, data_df_2000_2013, values_2022)
